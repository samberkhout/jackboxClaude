  ...
  return (
    <div className="card">
      <div className="text-center mb-4">
        ...
        <h2 className="text-xl font-bold">Pick the Best T-Shirt!</h2>
      </div>
      ...
      <div className="space-y-4">
        {currentDuel.comboA && (
          ...
          >
            <img src={currentDuel.comboA.drawing?.data} alt="Design A" className="w-full rounded mb-2" />
            <div className="text-center font-medium">{currentDuel.comboA.slogan?.text}</div>
          </button>
        )}
        ...
        {currentDuel.comboB && (
          ...
          >
            <img src={currentDuel.comboB.drawing?.data} alt="Design B" className="w-full rounded mb-2" />
            <div className="text-center font-medium">{currentDuel.comboB.slogan?.text}</div>
          </button>
        )}
      </div>
